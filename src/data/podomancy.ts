...
export const dailyHoroscope = [
  { sign: "Aries", symbol: "♈", horoscope: "Your energetic drive is at its peak. Take that leap of faith!" },
  { sign: "Taurus", symbol: "♉", horoscope: "Focus on grounding yourself today. Stability will bring you peace." },
  { sign: "Gemini", symbol: "♊", horoscope: "Communication is key today. Speak your truth but listen closely." },
  { sign: "Cancer", symbol: "♋", horoscope: "Trust your intuition, it is stronger than ever right now." },
  { sign: "Leo", symbol: "♌", horoscope: "Your natural charisma shines today. Step into the spotlight." },
  { sign: "Virgo", symbol: "♍", horoscope: "Attention to detail will help you solve a complex problem." },
  { sign: "Libra", symbol: "♎", horoscope: "Seek balance in your relationships. Harmony is within reach." },
  { sign: "Scorpio", symbol: "♏", horoscope: "Embrace transformation. A change of perspective is needed." },
  { sign: "Sagittarius", symbol: "♐", horoscope: "Adventure calls. Explore a new idea or physical space." },
  { sign: "Capricorn", symbol: "♑", horoscope: "Hard work pays off. Keep your eyes on your long-term goals." },
  { sign: "Aquarius", symbol: "♒", horoscope: "Your innovative ideas will inspire those around you today." },
  { sign: "Pisces", symbol: "♓", horoscope: "Your creative energy is flowing. Channel it into something beautiful." },
];
